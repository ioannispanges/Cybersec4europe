...
//	@Ignore
	...
	public void generateOIDCDockerConfiguration() throws Exception{
		...
		SAN = new String[][] {{"localhost", "host.docker.internal"},{"localhost", "host.docker.internal"},{"localhost", "host.docker.internal"}};
	...
	private Set<AttributeDefinition> generateAttributeDefinitions() {
		...
		res.add(new AttributeDefinitionString("Course","Course",0,123));
		res.add(new AttributeDefinitionString("University","University",0,123));
		res.add(new AttributeDefinitionString("StudentId","StudentId",0,16));
